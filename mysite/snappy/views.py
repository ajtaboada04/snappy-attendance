...
class HomeView(View):
    ...
    template_name = "snappy/main.html"
...
class StudentDashboardView(LoginRequiredMixin, View):
    ...
    # HTML template rendered when the page is opened
    template_name = 'snappy/student_dashboard.html'
...
class ProfessorDashboardView(LoginRequiredMixin, View):
    ...
    template_name = 'snappy/professor_dashboard.html'
...
class DisplayCodesView(View):
    ...
    # Template to render
    template_name = 'snappy/attendance.html'
...
class AttendanceManagementeView(LoginRequiredMixin, View):
    ...
    # Template to render
    template_name = "snappy/attendance_management.html"
    ...
    def post(self, request):
        ...
        return render(request, "snappy/confirmation.html", context)
...
class ConfirmationView(LoginRequiredMixin, View):
    ...
    # Template to render
    template_name = "snappy/confirmation.html"
...
class StudentAttendanceView(LoginRequiredMixin, View):
    ...
    # Template to render
    template_name = 'snappy/student_attendance.html'
...
class ProfessorAttendanceView(LoginRequiredMixin, View):
    ...
    # Template to render
    template_name = 'snappy/professor_attendance.html'
